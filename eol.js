(function() {
    ...
    function MainPageViewModel() {
        ...
        self.getNextPage = function(force_load) {
            ...
            var url = 'http://eol-api.dannysu.com/api.php?q='+self.search_term+'&page='+self.page+'&callback=?';
            if (self.collection_id != null) {
                if (self.collection_id == '31473') {
                    url = 'http://eol-api.dannysu.com/fav.php?page='+self.page;
                } else {
        ...
        self.collect = function(life, click, action) {
            ...
            var url = 'http://eol-api.dannysu.com/fav.php?';
